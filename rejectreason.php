		...
		<div class="container-login100" style="background-image: url('images/aitam ablock.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form" action="rejecteddata.php" method="POST" >
					...
					<div class="login100-form-avatar" style="border-radius: 0; overflow: hidden;">
    <img src="images/bitswgl_logo.jpg" alt="BITS Logo" style="width: 120px; height: 120px; object-fit: cover; border-radius: 20%;">
</div>
